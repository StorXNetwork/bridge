...
describe('Config', function() {
  ...
  describe('@getPaths', function() {
    it('it will use defaults if confpath and datadir are undefined', function() {
      ...
      expect(paths.datadir).to.equal(process.env.HOME + '/.storx-bridge');
      expect(paths.confdir).to.equal(process.env.HOME + '/.storx-bridge/config');
      expect(paths.confpath).to.equal(process.env.HOME + '/.storx-bridge/config/development');
    });
